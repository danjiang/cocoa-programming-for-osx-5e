...
class DieView: NSView, NSDraggingSource {
    ...
    func drawDieWithSize(size: CGSize) {
        if let intValue = intValue {
            ...
            if (1...6).indexOf(intValue) != nil {
                ...
                if [2, 3, 4, 5, 6].indexOf(intValue) != nil {
                    drawDot(0, 1)
                    drawDot(1, 0)
                }
                if [4, 5, 6].indexOf(intValue) != nil {
                    drawDot(1, 1)
                    drawDot(0, 0)
                }
                if intValue == 6 {
    ...
    func roll() {
        ...
        NSTimer.scheduledTimerWithTimeInterval(0.15, target: self, selector: "rollTick:", userInfo: nil, repeats: true)
